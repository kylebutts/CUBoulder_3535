...
table <- tribble(
  ...
  as.character(icons::fontawesome("laptop-house")), "Office Hours", "TBD (via survey)", "<a href = 'https://cuboulder.zoom.us/s/3975335005'>Zoom</a>",
  as.character(icons::fontawesome("chalkboard-teacher")), "TA", "TBD", "<a href = 'emailto:TBD@colorado.edu'>TBD</a>",
