  ...
  \answer{
    \begin{enumerate}
      ...
      \begin{enumerate}
        ...
        \item Permits would sell for $MC_x(a_x^*) = MC_y(a_y^*) = \$700$. 
      \end{enumerate}
  
      \item Assume that the control authority wanted to reach its objective by using an emissions charge system instead.
      \begin{enumerate}
        \item The tax price should equal $\$700$ to reach the same outcome. 
        \item The firms would pollute 19 units generating total government revenue of $19 * 700 = \$ 13,300$. 
      \end{enumerate}
